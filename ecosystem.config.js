module.exports = {
  apps: [
    // {
    //   name: "ai_service",
    //   cwd: "./backend_services/ai_service",
    //   script: "dist/main.js",
    //   interpreter: "node",
    //   env_file: "/opt/graduation-project/backend_services/ai_service/.env",
    // },
    {
      name: "api_gateway",
    ...
    },
    {
      ...
      script: "dist/main.js",
      interpreter: "node",
      env_file: "/opt/graduation-project/backend_services/course_service/.env",
    },
    {
