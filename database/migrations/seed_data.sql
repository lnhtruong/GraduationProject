...
VALUES (
        ...
        'course',
        11,
        'Nội dung khóa ChatGPT sử dụng prompt không an toàn, ví dụ jailbreak có khả năng vi phạm chính sách.',
        'approved',
        17,
        1,
        'Đã ẩn khóa học. Yêu cầu giảng viên chỉnh sửa nội dung trước khi tái duyệt.',
        '2026-07-05 09:30:00',
        '2026-07-04 08:30:00',
        '2026-07-05 09:30:00'
    ),
    (
        ...
        'course',
        5,
        'Khóa học JavaScript có 1 đoạn nói nhanh khó nghe, có phụ đề tiếng Anh nhưng chưa có phụ đề tiếng Việt.',
        'rejected',
        16,
        1,
        'Không phạm chính sách - chỉ là phản hồi chất lượng. Đã chuyển phản hồi cho giảng viên.',
        '2026-06-28 09:00:00',
        '2026-06-27 14:00:00',
        '2026-06-28 09:00:00'
    ),
    (
        ...
        'lesson',
        22,
        'Nội dung khóa ChatGPT bài 1 - giá hơi cao so với thời lượng.',
        'pending',
        18,
        NULL,
        NULL,
    ...
    (
        ...
        'teacher',
        8,
        'Mong giảng viên cải thiện chất lượng âm thanh bài SEO, có nhiễu nền.',
        'pending',
        24,
        NULL,
        NULL,
    ...
    (
        ...
        'course',
        19,
        'Khóa Power BI cần thêm bộ dữ liệu thực tế để tải về làm bài tập.',
        'pending',
        21,
        NULL,
        NULL,
...
VALUES (
    ...
    (
        2,
        19,
        'Tôi muốn chia sẻ phương pháp ghi chú và học nhóm đã áp dụng trong các lớp đại học.',
        'rejected',
        1,
    ...
    (
        3,
        23,
        'Tôi đang chuẩn bị khóa Excel nhập môn cho sinh viên năm nhất, đã có đề cương và video mẫu.',
        'pending',
        NULL,
        NULL,
        NULL,
    ...
    (
        4,
        24,
        'Tôi có 4 năm kinh nghiệm làm UI/UX Designer tại công ty công nghệ và mong muốn chia sẻ quy trình thiết kế Figma chuyên nghiệp.',
        'pending',
        NULL,
        NULL,
        NULL,
    ...
    (
        5,
        21,
        'Tôi từng giảng dạy lập trình Mobile Flutter và đã hoàn thành giáo trình bài giảng ngắn gọn.',
        'approved',
        1,
