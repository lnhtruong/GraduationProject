...
-- ============================================================================
INSERT INTO
    feed_interactions (id, user_id, highlight_id, type, created_at)
VALUES
    (181, 12, 104, 'like', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 52 MINUTE)),
    (182, 14, 104, 'like', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 49 MINUTE)),
    (183, 16, 104, 'like', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 46 MINUTE)),
    (184, 17, 104, 'save', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 43 MINUTE)),
    (185, 19, 104, 'save', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 40 MINUTE)),
    (186, 20, 104, 'share', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 37 MINUTE)),
    (187, 23, 104, 'share', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 34 MINUTE)),
    (188, 11, 120, 'like', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 51 MINUTE)),
    (189, 13, 120, 'like', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 48 MINUTE)),
    (190, 15, 120, 'like', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 45 MINUTE)),
    (191, 17, 120, 'save', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 42 MINUTE)),
    (192, 19, 120, 'save', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 39 MINUTE)),
    (193, 20, 120, 'share', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 36 MINUTE)),
    (194, 22, 120, 'share', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 33 MINUTE)),
    (195, 12, 138, 'like', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 50 MINUTE)),
    (196, 13, 138, 'like', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 47 MINUTE)),
    (197, 15, 138, 'like', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 44 MINUTE)),
    (198, 17, 138, 'save', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 41 MINUTE)),
    (199, 19, 138, 'save', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 38 MINUTE)),
    (200, 20, 138, 'share', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 35 MINUTE)),
    (201, 22, 138, 'share', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 32 MINUTE)),
    (202, 11, 216, 'like', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 31 MINUTE)),
    (203, 12, 216, 'like', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 29 MINUTE)),
    (204, 14, 216, 'like', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 27 MINUTE)),
    (205, 16, 216, 'save', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 25 MINUTE)),
    (206, 17, 216, 'save', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 23 MINUTE)),
    (207, 19, 216, 'share', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 21 MINUTE)),
    (208, 20, 216, 'share', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 19 MINUTE)),
    (209, 12, 234, 'like', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 30 MINUTE)),
    (210, 13, 234, 'like', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 28 MINUTE)),
    (211, 14, 234, 'like', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 26 MINUTE)),
    (212, 15, 234, 'save', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 24 MINUTE)),
    (213, 16, 234, 'save', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 22 MINUTE)),
    (214, 17, 234, 'share', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 20 MINUTE)),
    (215, 20, 234, 'share', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 18 MINUTE)),
    (216, 12, 280, 'like', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 17 MINUTE)),
    (217, 13, 280, 'like', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 15 MINUTE)),
    (218, 14, 280, 'like', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 13 MINUTE)),
    (219, 15, 280, 'save', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 11 MINUTE)),
    (220, 16, 280, 'save', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 9 MINUTE)),
    (221, 17, 280, 'share', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 7 MINUTE)),
    (222, 19, 280, 'share', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 5 MINUTE)),
    (223, 11, 72, 'like', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 16 MINUTE)),
    (224, 12, 72, 'like', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 14 MINUTE)),
    (225, 13, 72, 'like', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 12 MINUTE)),
    (226, 14, 72, 'save', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 10 MINUTE)),
    (227, 16, 72, 'save', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 8 MINUTE)),
    (228, 17, 72, 'share', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 6 MINUTE)),
    (229, 19, 72, 'share', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 4 MINUTE)),
    (230, 11, 209, 'like', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 15 MINUTE)),
    (231, 12, 209, 'like', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 13 MINUTE)),
    (232, 13, 209, 'like', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 11 MINUTE)),
    (233, 14, 209, 'save', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 9 MINUTE)),
    (234, 16, 209, 'save', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 7 MINUTE)),
    (235, 17, 209, 'share', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 5 MINUTE)),
    (236, 19, 209, 'share', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 3 MINUTE)),
    -- Deliberately different volumes so guest trending has meaningful ranks.
    (237, 21, 104, 'like', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 18 MINUTE)),
    (238, 22, 104, 'save', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 16 MINUTE)),
    (239, 24, 104, 'share', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 14 MINUTE)),
    (240, 25, 104, 'like', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 12 MINUTE)),
    (241, 21, 216, 'save', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 10 MINUTE)),
    (242, 22, 216, 'like', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 8 MINUTE)),
    (243, 23, 216, 'share', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 6 MINUTE)),
    (244, 21, 234, 'like', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 10 MINUTE)),
    (245, 22, 234, 'share', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 8 MINUTE)),
    (246, 21, 120, 'like', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 6 MINUTE)),
    (247, 24, 120, 'like', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 4 MINUTE)),
    (248, 21, 138, 'like', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 6 MINUTE)),
    (249, 22, 72, 'save', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 4 MINUTE)),
    (250, 22, 209, 'share', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 2 MINUTE));

INSERT INTO
    feed_comments (id, highlight_id, user_id, content, origin_cmt, created_at, updated_at)
VALUES
    (86, 104, 12, 'Ví dụ CORS thực tế rất dễ áp dụng. Mình đã sửa được lỗi gọi API local.', NULL, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 35 MINUTE), DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 35 MINUTE)),
    (87, 104, 4, 'Tốt quá em. Nhớ chỉ mở origin cần thiết khi đưa API lên production nhé.', 86, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 32 MINUTE), DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 32 MINUTE)),
    (88, 120, 13, 'Phần Node.js này giúp mình hiểu rõ luồng chạy server hơn nhiều.', NULL, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 31 MINUTE), DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 31 MINUTE)),
    (89, 120, 4, 'Em thử tạo một API nhỏ sau video để nhớ kiến thức lâu hơn nhé.', 88, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 29 MINUTE), DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 29 MINUTE)),
    (90, 138, 14, 'Ví dụ về function ngắn gọn, xem xong là làm bài được luôn.', NULL, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 28 MINUTE), DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 28 MINUTE)),
    (91, 138, 4, 'Cảm ơn em, phần tiếp theo mình sẽ ghép function vào project nhỏ.', 90, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 26 MINUTE), DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 26 MINUTE)),
    (92, 216, 16, 'Gradient và shadow giải thích rất trực quan, mình đã áp dụng vào file Figma.', NULL, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 25 MINUTE), DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 25 MINUTE)),
    (93, 216, 7, 'Hay quá, em thử kết hợp thêm Auto Layout để giao diện nhất quán hơn nha.', 92, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 23 MINUTE), DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 23 MINUTE)),
    (94, 234, 17, 'Slicer trong Power BI đúng là phần mình đang cần cho dashboard bán hàng.', NULL, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 22 MINUTE), DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 22 MINUTE)),
    (95, 234, 13, 'Mình cũng dùng cách này để lọc báo cáo theo tháng, khá tiện.', 94, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 20 MINUTE), DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 20 MINUTE)),
    (96, 280, 19, 'Checklist SEO có thứ tự rõ ràng nên mình biết bắt đầu tối ưu từ đâu.', NULL, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 19 MINUTE), DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 19 MINUTE)),
    (97, 280, 8, 'Đúng rồi em, ưu tiên nội dung hữu ích và kiểm tra định kỳ các trang cũ.', 96, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 17 MINUTE), DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 17 MINUTE)),
    (98, 72, 20, 'Cách đọc chỉ số đánh giá model dễ hiểu hơn mình tưởng.', NULL, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 16 MINUTE), DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 16 MINUTE)),
    (99, 72, 6, 'Em có thể thử lại với một dataset nhỏ để thấy sự khác nhau giữa các metric.', 98, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 14 MINUTE), DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 14 MINUTE)),
    (100, 209, 23, 'Histogram được minh hoạ rõ nên mình tự tin chỉnh exposure hơn rồi.', NULL, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 13 MINUTE), DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 13 MINUTE)),
    (101, 209, 7, 'Tuyệt vời, em thử chụp cùng một cảnh ở vài mức exposure để luyện mắt nhé.', 100, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 11 MINUTE), DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 11 MINUTE));

INSERT INTO
    feed_views (id, user_id, highlight_id, watch_duration, completed, viewed_at)
VALUES
    (141, 11, 104, 150, 1, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 34 MINUTE)),
    (142, 12, 104, 104, 0, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 30 MINUTE)),
    (143, 14, 104, 126, 0, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 26 MINUTE)),
    (144, 16, 104, 170, 1, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 22 MINUTE)),
    (145, 11, 120, 130, 1, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 33 MINUTE)),
    (146, 13, 120, 82, 0, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 29 MINUTE)),
    (147, 15, 120, 110, 0, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 25 MINUTE)),
    (148, 17, 120, 145, 1, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 21 MINUTE)),
    (149, 11, 138, 155, 1, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 32 MINUTE)),
    (150, 12, 138, 94, 0, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 28 MINUTE)),
    (151, 15, 138, 121, 0, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 24 MINUTE)),
    (152, 19, 138, 170, 1, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 20 MINUTE)),
    (153, 11, 216, 150, 1, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 31 MINUTE)),
    (154, 14, 216, 101, 0, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 27 MINUTE)),
    (155, 16, 216, 128, 0, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 23 MINUTE)),
    (156, 20, 216, 176, 1, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 19 MINUTE)),
    (157, 11, 234, 150, 1, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 30 MINUTE)),
    (158, 13, 234, 99, 0, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 26 MINUTE)),
    (159, 17, 234, 124, 0, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 22 MINUTE)),
    (160, 20, 234, 178, 1, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 18 MINUTE)),
    (161, 11, 280, 150, 1, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 29 MINUTE)),
    (162, 12, 280, 105, 0, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 25 MINUTE)),
    (163, 16, 280, 130, 0, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 21 MINUTE)),
    (164, 19, 280, 180, 1, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 17 MINUTE)),
    (165, 11, 72, 120, 1, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 28 MINUTE)),
    (166, 13, 72, 76, 0, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 24 MINUTE)),
    (167, 17, 72, 98, 0, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 20 MINUTE)),
    (168, 20, 72, 145, 1, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 16 MINUTE)),
    (169, 11, 209, 150, 1, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 27 MINUTE)),
    (170, 12, 209, 97, 0, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 23 MINUTE)),
    (171, 16, 209, 125, 0, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 19 MINUTE)),
    (172, 23, 209, 176, 1, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 15 MINUTE)),
    ...
    (173, 11, 103, 140, 1, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 45 MINUTE)),
    (174, 11, 137, 180, 1, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 43 MINUTE)),
    (175, 11, 71, 180, 1, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 41 MINUTE)),
    (176, 11, 215, 180, 1, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 39 MINUTE)),
    (177, 11, 233, 150, 1, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 37 MINUTE));
