-- Migration 009: Tạo bảng transactions và transaction_items
-- Hỗ trợ 1 giao dịch mua nhiều course cùng lúc

-- ============================================================
-- Đảm bảo bảng courses tồn tại (vì các migration trước thiếu)
-- ============================================================
...
-- ============================================================
-- Bảng transactions (thay thế Payments cho luồng mới)
-- ============================================================
...
-- ============================================================
-- Bảng transaction_items (chi tiết: mỗi dòng = 1 course)
-- ============================================================
...
-- Index để tăng tốc truy vấn theo user
