    ...
    <div className="mt-6 w-full">
      ...
      <div className="flex items-center justify-center gap-6">
        ...
        <Button
          ...
          variant="outline"
          size="icon-lg"
          className="rounded-full border-border bg-background hover:bg-muted text-foreground shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md"
        ...
        <Button
          ...
          variant="outline"
          size="icon-lg"
          className="rounded-full border-border bg-background hover:bg-muted text-[#1877F2] shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md"
