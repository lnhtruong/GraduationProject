              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-1 text-sm leading-6 text-foreground/95">
                      {comment.content}
                    </p>
      ...
      <form onSubmit={(event) => void submitComment(event)} className="border-t border-border/70 p-4">
        <div className="space-y-2">
          ...
          <div className="flex items-center justify-between text-xs text-muted-foreground">
            ...
            <Button type="submit" disabled={!canSubmit} className="gap-2 rounded-full bg-primary text-primary-foreground hover:bg-primary/90">
              {createCommentMutation.isPending ? (
                <Loader2 className="h-4 w-4 animate-spin" />
              ) : (
